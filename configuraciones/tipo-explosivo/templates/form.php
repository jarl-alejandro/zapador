<header class="panel-heading bg-info margin-bottom">
   <h5 class="no-margin text-center">Regitrar Nuevo Tipo de Explosivo</h5>
</header>
<form class="">
  <input type="hidden" id="id" />
  <div class="col-xs-12 col-md-6 form-group">
    <input type="text" placeholder="Escribe un tipo de explosivo" class="form-control" 
      maxlength="80" onkeypress="letras()" id="tipo" />
  </div>
  <div class="col-xs-12 col-md-6 form-group">
