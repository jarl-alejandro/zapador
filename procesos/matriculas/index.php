<?php
  ...
  require "../../head.php";
  require "../../menu.php";
  $alumnos = $pdo->query("SELECT * FROM zview_nomina WHERE zn_tipo='tropa'");
  // $usuarios = $pdo->query("SELECT * FROM v_nomina WHERE zu_ced != '1234567890'  AND zn_gra='$idGrado'");

?>
<main class="container">
  <div class="row" id="tabla_principal" style="display:none">
